      ...
      <div className="max-w-7xl mx-auto px-6 sm:px-8 lg:px-[8%]">
        ...
        <div className="grid gap-10 sm:grid-cols-2 lg:grid-cols-[1.5fr_1.5fr_0.8fr] items-start">
          ...
          <div>
            ...
            <ul className="space-y-3 text-sm text-gray-300" style={{ fontFamily: "'Montserrat', sans-serif" }}>
              <li className="flex items-start gap-2">
                <span className="text-[#FF0066] mt-0.5">📍</span>
                <span>27 Novaliches Mendoza Village Project 8 Quezon City</span>
              </li>
              ...
              <li className="flex items-center gap-2">
                ...
                <a href="mailto:schatziesevents@gmail.com" className="hover:text-[#FF0066] transition">
        ...
        <div className="flex flex-col items-center justify-between gap-4 sm:flex-row">
          ...
          {/* Legal Links */}
          <div className="flex gap-6 text-sm text-gray-400" style={{ fontFamily: "'Montserrat', sans-serif" }}>
            <a href="#privacy" className="hover:text-[#FF0066] transition underline">
              Privacy Policy
            </a>
            <a href="#terms" className="hover:text-[#FF0066] transition underline">
              Terms of Service
            </a>
            <a href="#cookies" className="hover:text-[#FF0066] transition underline">
              Cookie Policy
            </a>
          </div>
        </div>
