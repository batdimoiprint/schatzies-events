...
export function OverviewTab({ selectedProject, selectedEventDetails, eventAllocation, eventMeetings, checklistItems, overviewFlows }: OverviewTabProps) {
  const dynamicOverviewCards = [
    ...
    { id: 'overview-cost', label: 'Event Cost', value: selectedProject.eventCost ? String(selectedProject.eventCost) : 'TBD', imageSrc: '/Pictures/organizerpics/event-cost-illustration.png', accent: 'text-[#a6541d] bg-[#fff4ec] border-[#f3dccb]', valueClassName: 'text-[32px] font-semibold leading-none tracking-tight text-[#4f4a58]' },
  ];
