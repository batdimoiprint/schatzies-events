    ...
    <>
      ...
      <div
        style={{
          ...
          background:
            'linear-gradient(155deg, #fff1f5 0%, #ffffff 35%, #fce7f3 65%, #fbd5e8 100%)',
      ...
      >
        ...
        ] as Array<{ size: number; top?: string; left?: string; right?: string; bottom?: string; op: number }>)
          .map((b, i) => (
            <div
              key={i}
              style={{
        ...
        >
          ...
          <div
            style={{
              ...
              transition:
                'transform 0.85s cubic-bezier(0.34,1.42,0.64,1), opacity 0.5s ease',
              zIndex: 14,
              pointerEvents: 'none',
            }}
          >
            ...
            <div
              style={{
                ...
                textAlign: 'center',
                boxShadow:
                  '0 10px 34px rgba(223,43,128,0.14), 0 2px 10px rgba(0,0,0,0.06)',
              }}
            >
              ...
              ] as Array<{ top?: number; left?: number; right?: number; bottom?: number; transform: string }>)
                .map((c, idx) => (
                  <div
                    key={idx}
                    style={{
                  ...
                  >
                    <svg width="18" height="18" viewBox="0 0 18 18">
                      <path
                        d="M2 16 Q2 2 16 2"
                        stroke={PINK_LIGHT} strokeWidth="1"
                        fill="none" strokeLinecap="round"
                      />
          ...
          >
            ...
            <div
              style={{
                ...
                borderRadius: '5px',
                background:
                  `linear-gradient(170deg, ${CREAM} 0%, #fef5fb 60%, #fdeef8 100%)`,
            ...
            >
              ...
              <polygon
                ...
                fill="url(#lgLeft)"
                stroke={PINK_PALE} strokeWidth="0.8"
              />
              {/* right flap triangle */}
              <polygon
              ...
              {/* fold crease lines */}
              {[
                [1, 1], [EW - 1, 1], [1, EH - 1], [EW - 1, EH - 1],
              ].map(([x, y], i) => (
                <line
                  key={i}
                  x1={x} y1={y} x2={cx} y2={cy}
                  stroke={PINK_PALE} strokeWidth="0.55" strokeOpacity="0.55"
                />
              ))}
              ...
              {[0.62, 0.73, 0.83].map((ratio, i) => (
                <line
                  key={i}
                  x1="22" y1={EH * ratio}
                  x2={EW * (0.56 - i * 0.04)} y2={EH * ratio}
                  stroke={PINK_BLUSH} strokeWidth="1.1" strokeLinecap="round"
                />
              ))}
            </svg>
            ...
            <div
              style={{
                position: 'absolute', top: 13, right: 18, zIndex: 30,
              }}
            >
              ...
              >
                ...
                <div
                  style={{
                    width: 36, height: 44,
                    background:
                      'linear-gradient(145deg, #fff0f6, #fce7f3)',
                ...
                >
                  <span
                    style={{ fontSize: '18px', lineHeight: 1, color: PINK_BRAND }}
                  >
                    ♥
                  </span>
                  <div
                    style={{ width: '26px', height: '1px', background: PINK_PALE }}
                  />
                  <span
                    style={{
                      fontSize: '5px', color: PINK_DEEP,
            ...
            >
              <div
                style={{
                  ...
                  animation: flapOpen
                    ? 'flapOpen 1.1s cubic-bezier(0.4,0,0.2,1) forwards'
                    : 'none',
                }}
              >
              <svg
                width={EW} height={FLAP_TIP + 6}
                viewBox={`0 0 ${EW} ${FLAP_TIP + 6}`}
              >
                <defs>
                ...
                <polygon
                  ...
                  fill="url(#flapFront)"
                  stroke="#e879a8" strokeWidth="1"
                />
                {/* sheen */}
                <polygon
                  points={`22,0 ${EW - 22},0 ${cx},${FLAP_TIP * 0.80}`}
                  fill="url(#flapHighlight)"
                />
                {/* bottom edge shadow line */}
                <line
                  x1="1" y1="0" x2={cx} y2={FLAP_TIP}
                  stroke="rgba(0,0,0,0.08)" strokeWidth="1"
                />
                <line
                  x1={EW - 1} y1="0" x2={cx} y2={FLAP_TIP}
                  stroke="rgba(0,0,0,0.08)" strokeWidth="1"
                />
              </svg>
              </div>
...
{/* -- Sparkle burst when flap opens -- */}
          ...
          <div
            style={{
              ...
              pointerEvents: 'none',
              animation: !flapOpen
                ? 'sealPulse 1.8s 1.0s ease-in-out infinite'
                : 'none',
            }}
          >
            {/* outer glow ring */}
