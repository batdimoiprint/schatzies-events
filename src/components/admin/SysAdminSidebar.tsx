      ...
      <div className="flex w-full shrink-0 flex-col items-center justify-start px-5 pt-3 pb-2">
        {isMobile || expanded ? (
          <div className="flex items-center gap-3">
            ...
            <div className="leading-tight">
              <p className="font-heading text-base font-bold text-brand">SysAdmin</p>
        ...
        {(isMobile || expanded) && (
          <p className="mt-3 text-center text-xs font-semibold tracking-wide text-muted-foreground">
            Your <span className="text-brand">SYSADMIN</span> dashboard!
          </p>
        )}
      </div>
            ...
            className={({ isActive }) =>
              isMobile || expanded
                ? [
                    ...
                    isActive
                      ? 'bg-gradient-brand text-white shadow-lg shadow-brand-deep/25'
                      : 'text-foreground/75 hover:bg-brand/5 hover:text-brand-deep hover:translate-x-1',
                  ].join(' ')
                : [
                    'flex size-10 items-center justify-center rounded-xl transition-all',
                    isActive
                      ? 'bg-gradient-brand text-white shadow-md shadow-brand-deep/25'
