    ...
    <div className="space-y-4">
      <section className="flex gap-3">
        ...
        <div>
          ...
          <p className="text-sm">
            At Schatzies Events Management, we are committed to protecting your privacy and ensuring
      ...
      <section className="flex gap-3">
        ...
        <div>
          ...
          <p className="text-sm">
            ...
            without your consent, except as described in this policy or required by law. We may
      ...
      <section className="flex gap-3">
        ...
        <div>
          ...
          <p className="text-sm">
            ...
            contact us using the information provided in our Contact page.
          </p>
        </div>
      </section>
