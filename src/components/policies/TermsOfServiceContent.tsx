      ...
      <section className="flex gap-3">
        ...
        <div>
          ...
          <p className="text-sm">
            ...
            occasions. Our services include consultation, planning, coordination, and execution of
            events.
          </p>
        </div>
      </section>
      ...
      <section className="flex gap-3">
        ...
        <div>
          ...
          <p className="text-sm">
            ...
            additional fees. All payments are non-refundable unless otherwise specified in writing.
          </p>
        </div>
      </section>
      ...
      <section className="flex gap-3">
        ...
        <div>
          ...
          <p className="text-sm">
            ...
            or issues caused by third parties. Our liability is limited to the amount paid for our
            services.
          </p>
        </div>
      </section>
      ...
      <section className="flex gap-3">
        ...
        <div>
          ...
          <p className="text-sm">
            ...
            or distribute our proprietary materials without permission.
          </p>
        </div>
      </section>
