...
const mockNotifications = [
  ...
  },
  {
    id: 2,
    type: 'event',
    message: 'New event "Tech Summit 2024" requires approval',
    time: '1 hour ago',
    icon: CalendarClock,
    color: 'text-[#8f1fd0]',
    bg: 'bg-[#f0e8f5]',
  },
  {
    id: 3,
    type: 'message',
    message: 'You have 3 unanswered inquiries from yesterday',
    time: '5 hours ago',
    icon: MessageSquare,
  ...
  },
  {
    id: 4,
    type: 'system',
    message: 'Weekly performance report is ready to download',
    time: '1 day ago',
    icon: Bell,
    color: 'text-blue-500',
    bg: 'bg-blue-100',
