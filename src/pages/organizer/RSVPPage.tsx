...
import { Search, Phone, Video, Info, MoreVertical, Paperclip, Mic, Send, X } from 'lucide-react';
...
// KEEP THE NAME AS RSVPPage TO PREVENT ROUTING ERRORS
export function RSVPPage() {
  ...
  return (
    <div className="flex h-[calc(100vh-120px)] w-full gap-6 bg-transparent">
      ...
      <div className="flex flex-1 flex-col overflow-hidden rounded-2xl border border-[#e2deea] bg-white shadow-sm transition-all duration-300">
        ...
        <div className="flex items-center justify-between border-b border-[#f0edf4] px-6 py-4">
          ...
          <div className="flex items-center gap-4 text-[#8f879f]">
            <button className="transition-colors hover:text-[#df2b80]">
        ...
        <div className="border-t border-[#f0edf4] bg-white p-4">
          <div className="flex items-center gap-3 rounded-full border border-[#e2deea] bg-[#f6f5f8] px-4 py-2">
            <button className="transition-colors text-[#a49cb3] hover:text-[#df2b80]">
            ...
            <button className="flex size-8 items-center justify-center rounded-full bg-[#df2b80] text-white transition-colors hover:bg-[#c92472]">
      ...
      {showDetails && (
        <div className="flex w-[320px] shrink-0 flex-col overflow-y-auto overflow-x-hidden rounded-2xl border border-[#e2deea] bg-white shadow-sm animate-in slide-in-from-right-4 fade-in duration-300">
          {/* Header */}
          <div className="flex items-center justify-between border-b border-[#f0edf4] px-6 py-4 sticky top-0 bg-white z-10">
          ...
          <div className="flex flex-col items-center px-6 pb-6 pt-8 text-center">
            ...
            <h4 className="text-lg font-bold text-[#2d2834] leading-tight">{activeChat.name}</h4>
            <span className="mt-2 rounded-full bg-[#f8f5fe] px-4 py-1 text-xs font-bold tracking-wide text-[#8f1fd1] uppercase">
              {activeChat.role}
            </span>
            <p className="mt-4 text-sm font-medium text-[#696373] italic">
          ...
          <div className="flex flex-col gap-5 border-t border-[#f0edf4] p-6">
            <div>
              ...
              <p className="mt-1 text-sm font-semibold text-[#2d2834] break-all">
                {activeChat.email}
              </p>
            </div>
            <div>
