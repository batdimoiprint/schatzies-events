  ...
  return (
    <>
      ...
      <ScrollReveal>
        ...
        >
          {/* Gradient overlay from bottom - white to pink to violet */}
          <div className="absolute inset-0 bg-gradient-to-t from-white via-[#FF589C]/40 to-[#4A1053]/30" />
          ...
          <div className="relative z-10 flex flex-1 flex-col items-center justify-center px-4 pb-12 text-center sm:px-6 sm:pb-16 lg:pb-[173px] animate-fade-in-up">
            ...
            <p className="mt-3 max-w-[40rem] text-[clamp(0.9rem,1.8vw,1.3rem)] leading-[1.7] font-sans text-black/80 drop-shadow-lg sm:mt-4 sm:max-w-[45rem] lg:mt-6 lg:max-w-[50rem] lg:text-[1.4rem] animate-slide-in-left animation-delay-200">
              At Schatzies Events PH, we believe you should be a guest at your own celebration.
              Since 2011, we&rsquo;ve been the trusted partner for families and couples across the
              Philippines and beyond.
            </p>

            <Button
              onClick={() => setInquiryOpen(true)}
              className="mt-5 h-10 rounded-full bg-white px-6 text-[0.85rem] font-bold uppercase tracking-wide shadow-[0_10px_20px_rgba(39,21,57,0.25),inset_0_-2px_0_rgba(0,0,0,0.05)] hover:shadow-[0_15px_25px_rgba(39,21,57,0.35),inset_0_-1px_0_rgba(0,0,0,0.05)] hover:bg-gray-50 active:translate-y-px active:shadow-[0_5px_10px_rgba(39,21,57,0.2)] sm:mt-6 sm:h-12 sm:px-8 sm:text-[1rem] lg:mt-8 lg:h-14 lg:px-10 lg:text-[1.1rem] animate-slide-in-left animation-delay-400"
            >
              <span
                style={{
